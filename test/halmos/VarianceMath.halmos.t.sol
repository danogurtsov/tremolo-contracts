...
///      failed to change it.
///
///      So this file proves what is provable. What remains is covered by 50 000-run fuzzing
///      and by the invariant suites — weaker evidence. The properties that could not be
