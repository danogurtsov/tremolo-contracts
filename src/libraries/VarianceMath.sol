...
///
///      Path 1 is strictly more accurate and strictly cheaper, and is why the protocol
///      prefers tick-based sources.
library VarianceMath {
    ...
    ///      Deposits therefore total exactly `notional * cap * K`, which is what the two
    ///      payouts sum to — the reason this instrument needs no liquidations.
