...
**2. The variance risk premium shows up.** Selling
at a 20% premium turns the short side's edge from marginal into systematic: long mean P&L drops
to −14.8%, at 50% to −29.4%. A maker selling at a premium has a reason to quote.
...
a step function. 2.5× lands between those.

**4. Nobody buys this to make money on average.** The intended
...
**The strike rule is naive.** A trailing mean is the simplest estimator that uses no
